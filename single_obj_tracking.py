...
class Single_Obj_Tracking(tk.Frame):
    def __init__(self, master, controller):
        ...
        self.pageTitle = Label(self, text="LSTM based Single Object Tracking", font=LARGE_FONT)
        self.pageTitle.grid(row=0, column=1, columnspan = 2)
        self.pageTitle1 = Label(self, text="Training The LSTM model")
        self.pageTitle1.grid(row=1, column=0, sticky="we")
        self.pageTitle2 = Label(self, text="Enter No. Epoches for training")
        self.pageTitle2.grid(row=2, column=0, sticky ="we")
        self.epoches_entry = tk.Entry(self)
        self.epoches_entry.grid(row=2, column=1)
        self.epoches_button = tk.Button(self, text="Ok", command=self.get_epoches)
        self.epoches_button.grid(row=2, column=2,  sticky="we")
        self.pageTitle2 = Label(self, text="Train the model")
        self.pageTitle2.grid(row=3, column=0, sticky="we")
        self.browse_button1 = Button(self, text="Training", command=self.train)
        self.browse_button1.grid(row=3, column=1, sticky="we")
        self.pageTitle2 = Label(self, text="Test the model")
        self.pageTitle2.grid(row=4, column=0, sticky="we")
        self.browse_button2 = Button(self, text="Testing(yet to implement")
        self.browse_button2.grid(row=4, column=1, sticky="we")
        self.label_tracking = Label(self, text="Object Tracking")
        ...
        self.tracking_option.grid(row=6, column=1,sticky="news")
        self.tracking_button = Button(self, text="Ok", command=self.ok)
        self.tracking_button.grid(row=6, column=2, sticky="news")
...
class ROLO_TF(Single_Obj_Tracking):
	...
	#tkMessageBox.showinfo("Success", "Training completed")	
