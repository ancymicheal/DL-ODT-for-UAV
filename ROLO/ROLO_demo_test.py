...
import numpy as np
import sys
sys.path.append('/home/ancymicheal/ROLO/utils')
...
def main(argv):
    ...
    img_fold_path = os.path.join('/home/ancymicheal/ROLO/benchmark/DATA', sequence_name, 'img/')
    gt_file_path= os.path.join('/home/ancymicheal/ROLO/benchmark/DATA', sequence_name, 'groundtruth_rect.txt')
    yolo_out_path= os.path.join('/home/ancymicheal/ROLO/benchmark/DATA', sequence_name, 'yolo_out/')
    rolo_out_path= os.path.join('/home/ancymicheal/ROLO/benchmark/DATA', sequence_name, 'rolo_out_train/')
    ...
    for i in range(len(paths_rolo)- num_steps):
        ...
        utils.createFolder(os.path.join('/home/ancymicheal/ROLO/output/frames/',sequence_name))
        frame_name= os.path.join('/home/ancymicheal/ROLO/output/frames/',sequence_name,str(test_id)+'.jpg')
        print(frame_name)
