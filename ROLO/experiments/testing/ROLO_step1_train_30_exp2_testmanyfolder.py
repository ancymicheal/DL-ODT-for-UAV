...
class ROLO_TF:
    ...
    # YOLO parameters
    fromfile = None
    tofile_img = 'ROLO/DATA/output.jpg'
    tofile_txt = 'ROLO/DATAt/output.txt'
    imshow = True
    filewrite_img = False
    filewrite_txt = False
    yolo_weights_file = 'ROLO/DATA/weights/YOLO_small.ckpt'
    alpha = 0.1
    threshold = 0.2
    iou_threshold = 0.5
    num_class = 20
    ...
    def train_30_2(self):
        print("TRAINING ROLO...")
        log_file = open("ROLO/output/trainging-step1-exp2.txt", "a")  # open in append mode
        self.build_networks()
